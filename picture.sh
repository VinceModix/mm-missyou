...
# usage:
#----------------------------------------------------------------
# ./takePic.sh filename directory delay width height
#----------------------------------------------------------------

# init defaults

defaultFILENAME="cam"$(date +%s)".jpg" # filename cam12345678.jpg
defaultDIR="/home/pi/cam"
defaultDELAY=3000 # 3 seconds delay
defaultWIDTH=1920
defaultHEIGHT=1080
